...
def upload_handler_module(mock_boto3_clients) -> Any:
    ...
    original_get_s3_client = upload_handler.get_s3_client
    original_get_results_table = upload_handler.get_results_table

    upload_handler.get_s3_client = lambda: mock_boto3_clients["s3"]
    upload_handler.get_results_table = lambda: mock_boto3_clients["dynamodb_table"]

    try:
        yield upload_handler
    finally:
        upload_handler.get_s3_client = original_get_s3_client
